...
function Navbar() {
  return (
    <nav className="flex flex-col px-20 py-8 gap-6 w-full mx-auto">
      ...
      <div className="flex justify-end items-center gap-3 text-[12px] font-bold tracking-widest text-[#777777]">
        <div className="flex items-center gap-2">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-12 h-6 bg-[#4731D3] rounded-full peer peer-checked:bg-[#777777] after:content-[''] after:absolute after:top-[4px] after:left-[4px] after:bg-[#FFE86E] after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:after:translate-x-6"></div>
          </label>
