      ...
      <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-end items-center gap-6 md:gap-12 text-center">
            <a href="#skills" className="text-[#777777] dark:text-[#6B7280] font-medium text-base md:text-lg">
              {lang === "eng" ? "Skills" : "Yetenekler"}
            </a>
            <a href="#projects" className="text-[#777777] dark:text-[#6B7280] font-medium text-base md:text-lg">
